...
public class OldSilencerActivity extends AppCompatActivity
        implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener {

    private static final String TAG = "OldSilencerActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.silencer_activity_old);
    ...
    public void onCheckedChanged(View view) {
        SharedPreferences sharedPreferences = getApplicationContext().getSharedPreferences(
                OldSilencerActivity.class.getName(), 0);
